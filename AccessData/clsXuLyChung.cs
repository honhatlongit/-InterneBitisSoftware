...
{
    public static class clsXuLyChung
    {
        ...
        public static bool sosanhngaythang(DateTime firstDate, DateTime lastDate)
        {
            TimeSpan ts = lastDate.Date - firstDate.Date;
            if (ts.Days < 0)
            {
                return false;
            }
        ...
        /// <summary>
        /// Convert 1 object sang kiểu dữ liệu Nullable
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="val"></param>
        /// <returns></returns>
        public static Nullable<T> ConvertExcelTypeIntoNullable<T>(object val) where T : struct
        {
            if (val == null)
            {
                return null;
            ...
            return (T)conv.ConvertFrom(val.ToString());
        }
    }
}
